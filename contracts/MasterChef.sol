...
contract MasterChef is Ownable {
    ...
    function add(
        ...
        uint256 lastRewardBlock = block.number > startRewardBlock ? block.number : startRewardBlock;
    ...
    function harvestPendingReward(uint256 _pid) public {
        ...
        require(rewardToken.balanceOf(address(this)) > rewardFrozenTime, "This contract has not enough balance");
